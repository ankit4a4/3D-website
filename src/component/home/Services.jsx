  ...
  const services = [
    {
      ...
      icon: <Search className="w-[7vw] h-[7vw] md:w-[3.5vw] md:h-[3.5vw] text-white" />,
    ...
    },
    {
      ...
      icon: <Share2 className="w-[7vw] h-[7vw] md:w-[3.5vw] md:h-[3.5vw] text-white" />,
      color: "from-[#3298c9] to-[#3298c9]",
      hoverColor: "from-[#2877a6] to-[#2877a6]",
    ...
    },
    {
      ...
      icon: <BarChart3 className="w-[7vw] h-[7vw] md:w-[3.5vw] md:h-[3.5vw] text-white" />,
      color: "from-[#3298c9] to-[#3298c9]",
      hoverColor: "from-[#2877a6] to-[#2877a6]",
    ...
    },
    {
      ...
      icon: <PenTool className="w-[7vw] h-[7vw] md:w-[3.5vw] md:h-[3.5vw] text-white" />,
      color: "from-[#3298c9] to-[#3298c9]",
      hoverColor: "from-[#2877a6] to-[#2877a6]",
    ...
    >
      ...
      <div className=" mx-auto relative z-10">
                ...
                <ul className="mb-[3vh]">
                  {service.features.map((feature, i) => (
                    <li key={i} className="flex items-center mb-[1.2vh]">
                      ...
                      <span className="text-gray-100 text-[2vh] md:text-[1vw]">{feature}</span>
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-[3vh] mt-[10vh]">
          <StatBox
            icon={<Target className="w-[4.5vw] h-[4.5vw] md:w-[2.5vw] md:h-[2.5vw] text-[#3298c9]" />}
            bg="bg-[#3298c9]/20"
            value="95%"
            label="Client Satisfaction"
          />
          <StatBox
            icon={<TrendingUp className="w-[4.5vw] h-[4.5vw] md:w-[2.5vw] md:h-[2.5vw] text-[#3298c9]" />}
            bg="bg-[#3298c9]/20"
            value="250+"
            label="Projects Completed"
          />
          <StatBox
            icon={<Users className="w-[4.5vw] h-[4.5vw] md:w-[2.5vw] md:h-[2.5vw] text-[#3298c9]" />}
            bg="bg-[#3298c9]/20"
            value="120+"
            label="Happy Clients"
          />
          <StatBox
            icon={<Zap className="w-[4.5vw] h-[4.5vw] md:w-[2.5vw] md:h-[2.5vw] text-[#3298c9]" />}
            bg="bg-[#3298c9]/20"
            value="5+"
...
function StatBox({ icon, bg, value, label }) {
  return (
    <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-[4vh] rounded-xl shadow-lg text-center transition-all duration-300 hover:shadow-2xl">
      <div className={`w-[9vw] h-[9vw] md:w-[5vw] md:h-[5vw] ${bg} rounded-full flex items-center justify-center mx-auto mb-[2vh]`}>
        {icon}
      </div>
      <h3 className="text-[3.5vh] md:text-[2.2vw] font-bold text-white">{value}</h3>
      <p className="text-gray-200 mt-[1vh] text-[2vh] md:text-[1.2vw]">{label}</p>
    </div>
  );
}
